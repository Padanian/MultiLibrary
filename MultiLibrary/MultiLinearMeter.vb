Public Class MultiLinearMeter
    ...
    Private Sub GaugePaint(sender As Object, e As PaintEventArgs) Handles Me.Paint
        ...
        y1 = 16
        x1 = 12
        e.Graphics.DrawLine(apen, x1, y1, x1 + 120, y1)
        Dim i As Integer = 0
        For num As Double = 12 To 132 Step 12
            x1 = num
            y1 = 14
            x2 = num
            y2 = 20
    ...
    Public Sub redrawLine(e As PaintEventArgs)
        Dim Lend As Double = 12 + (value - minimum) * 1.2 * (100 / (maximum - minimum)) '+ Math.Abs(minimum)
        Dim Lstart = 12
